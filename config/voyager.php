...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings', 'categories', 'menus', 'translations', 'pages', '', 'posts', 'permissions', 'sessions', 'users', 'roles', 'permission_groups'],
        ],
    ],
